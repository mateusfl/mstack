...
The **mauri-mode** skill shows the shape. Read it for granularity. Don't copy its content; the user's rules are not the same as mauri-mode's.
...
- The **mauri-mode** skill: example of the output shape.
